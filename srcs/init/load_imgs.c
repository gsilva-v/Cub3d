...
void	load_imgs(t_game *game)
{
	...
	game->resources.pov.img =  mlx_xpm_file_to_image(game->mlx, "./imgs/pov.xpm", &trash, &trash);
	game->resources.pov.addr = mlx_get_data_addr(game->resources.pov.img, &game->resources.pov.bits_per_pixel, &game->resources.pov.line_length, &game->resources.pov.endian);

	game->resources.wall.no.img = mlx_xpm_file_to_image(game->mlx, "./imgs/wall.xpm", &trash, &trash);
	...
	game->resources.wall.we.img = mlx_xpm_file_to_image(game->mlx, "./imgs/wall.xpm", &trash, &trash);
	...
	game->resources.wall.ea.img = mlx_xpm_file_to_image(game->mlx, "./imgs/wall.xpm", &trash, &trash);
